public class PersonInfo4 {
    ...
    public static String firstName = "Soufiane";
    public static String lastName = "Daoudi";
    public static int studentNo = 8430753;
    public static String description = "Likes Software & Civil eng";
