public class PersonInfo2 {
    ...
    public static String firstName = "Michel";
    public static String lastName = "Moore";
    public static int studentNo = 300063096;
    public static String description = "Pizza is good";
